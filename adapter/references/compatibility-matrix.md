...
| --- | --- | --- |
| `origin/4.6` at `a16e481cf424f8e39dc2cdea1a6bdc1e309acdc1` | Supported | Use `adapter/scripts/apply_godot_patchset.py` directly |
| Nearby `4.6`-based checkout with small local drift | Best effort | Use `--allow-base-mismatch`, expect conflict resolution, then replay `adapter/references/recent-commit-deltas.md` |
