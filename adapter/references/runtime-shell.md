...
Use this reference when replacing the old external `godot-minigame-sdk` dependency with the public runtime shell shipped under `adapter/assets/min-runtime/`.
